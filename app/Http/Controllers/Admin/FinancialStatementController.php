...
class FinancialStatementController extends Controller
{
    ...
    public function year($tvde_year_id)
    {
        ...
        $tvde_month = TvdeMonth::orderBy('number', 'desc')->where('year_id', session()->get('tvde_year_id'))
            ->whereHas('weeks')
            ->first();
        session()->put('tvde_month_id', $tvde_month->id);
        $tvde_week = TvdeWeek::orderBy('number', 'desc')->where('tvde_month_id', $tvde_month->id)->first();
