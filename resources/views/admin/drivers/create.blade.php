                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.drivers.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('uber_uuid_courier') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="uber_uuid_courier" id="uber_uuid_courier" value="{{ old('uber_uuid_courier', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('bolt_name_courier') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="bolt_name_courier" id="bolt_name_courier" value="{{ old('bolt_name_courier', '') }}">
