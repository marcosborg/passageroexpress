            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.drivers.update", [$driver->id]) }}"
                        ...
                        <div class="form-group {{ $errors->has('uber_uuid_courier') ? 'has-error' : '' }}">
                            <label for="uber_uuid_courier">{{ trans('cruds.driver.fields.uber_uuid_courier') }}</label>
                            <input class="form-control" type="text" name="uber_uuid_courier" id="uber_uuid_courier"
                                value="{{ old('uber_uuid_courier', $driver->uber_uuid_courier) }}">
                            @if($errors->has('uber_uuid_courier'))
                            <span class="help-block" role="alert">{{ $errors->first('uber_uuid_courier') }}</span>
                            @endif
                            <span class="help-block">{{ trans('cruds.driver.fields.uber_uuid_courier_helper') }}</span>
                        </div>
                        ...
                        <div class="form-group {{ $errors->has('bolt_name_courier') ? 'has-error' : '' }}">
                            <label for="bolt_name_courier">{{ trans('cruds.driver.fields.bolt_name_courier') }}</label>
                            <input class="form-control" type="text" name="bolt_name_courier" id="bolt_name_courier"
                                value="{{ old('bolt_name_courier', $driver->bolt_name_courier) }}">
                            @if($errors->has('bolt_name_courier'))
                            <span class="help-block" role="alert">{{ $errors->first('bolt_name_courier') }}</span>
                            @endif
                            <span class="help-block">{{ trans('cruds.driver.fields.bolt_name_courier_helper') }}</span>
                        </div>
